...
use envbed::replace_dollar_braces::{replace_dollar_braces, replace_dollar_braces_with_hashmap, replace_dollar_braces_with_hashmap_parallel};
...
fn bench_dollar_hash_parallel(c: &mut Criterion) {
  ...
  2fwah${KEY10}fasd${KEY10}fnadnfa0$${KEY10}2fwa${KEY10}hfasd${KEY10}fn${KEY10}${KEY10}adnfa";
    ...
    c.bench_function("replace_dollar_braces_with_hashmap_parallel", |b| {
        b.iter(|| replace_dollar_braces_with_hashmap_parallel(&envvars, target.to_owned(), 24))
    });
}
